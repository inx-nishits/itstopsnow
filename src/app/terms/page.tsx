  ...
  return (
    <div className="flex flex-col min-h-screen font-sans pb-16 lg:pb-32">
      <PageHero
        ...
        eyebrow={
          <>
            <Shield className="w-5 h-5 shrink-0" /> LEGAL AGREEMENT
          </>
        }
        title={
          <>
      ...
      <EditorialSection>
        ...
        <div className="prose prose-lg prose-editorial max-w-4xl">
          ...
          <h2 className="font-bold uppercase tracking-widest text-xl mb-4 mt-12">2. Use of the Site</h2>
          <p>
          ...
          <h2 className="font-bold uppercase tracking-widest text-xl mb-4 mt-12">3. Content Submissions</h2>
          <p>
          ...
          <h2 className="font-bold uppercase tracking-widest text-xl mb-4 mt-12">4. Disclaimers</h2>
          <p>
          ...
          <h2 className="font-bold uppercase tracking-widest text-xl mb-4 mt-12">5. Changes to Terms</h2>
          <p>
