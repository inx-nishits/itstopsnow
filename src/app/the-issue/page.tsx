        ...
        <div className="w-full px-6 lg:px-16 mx-auto relative z-10 max-w-[1600px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-[#050B14] border border-white/10 p-10 rounded-3xl relative overflow-hidden group shadow-2xl hover:border-[#1877F2]/50 transition-colors">
              ...
              <p className="text-slate-400 leading-relaxed text-sm relative z-10">Record numbers of highly trained officers are resigning voluntarily, citing a toxic culture of blame and lack of protection.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-[#020611] relative border-b border-white/5">
        <div className="w-full px-6 lg:px-16 mx-auto relative z-10 max-w-[1600px]">
          <div className="text-center mb-16">
            ...
            <h2 className="font-sans text-4xl md:text-5xl font-bold uppercase tracking-tight text-white mb-6">THE IMPACT</h2>
          ...
          <div className="bg-[#050B14] border border-white/10 rounded-3xl p-10 md:p-16 shadow-2xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <strong className="block text-white mb-1 uppercase tracking-wider text-sm">Severe Mental Health Decline</strong>
                      <span className="text-slate-400 text-sm leading-relaxed">Officers experience clinical depression, severe anxiety, and PTSD leading to tragic increases in suicide rates.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <CheckCircle className="w-6 h-6 text-[#1877F2] shrink-0 mt-0.5" />
                    <div>
                      <strong className="block text-white mb-1 uppercase tracking-wider text-sm">Financial Ruin</strong>
                      <span className="text-slate-400 text-sm leading-relaxed">Loss of overtime, suspension of pay progression, and massive legal fees to defend against false claims.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <CheckCircle className="w-6 h-6 text-[#1877F2] shrink-0 mt-0.5" />
                    <div>
                      <strong className="block text-white mb-1 uppercase tracking-wider text-sm">Family Breakdown</strong>
                      <span className="text-slate-400 text-sm leading-relaxed">Spouses and children carry the burden, leading to higher divorce rates and secondary trauma from intense media intrusion.</span>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h3 className="font-bold text-2xl text-white mb-8 border-b border-white/10 pb-4">On the Community</h3>
                <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                    <CheckCircle className="w-6 h-6 text-amber-500 shrink-0 mt-0.5" />
                    <div>
                      <strong className="block text-white mb-1 uppercase tracking-wider text-sm">De-Policing</strong>
                      <span className="text-slate-400 text-sm leading-relaxed">Fear of career-ending investigations causes risk-aversion, leading to fewer proactive stops and necessary interventions.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <CheckCircle className="w-6 h-6 text-amber-500 shrink-0 mt-0.5" />
                    <div>
                      <strong className="block text-white mb-1 uppercase tracking-wider text-sm">Loss of Experience</strong>
                      <span className="text-slate-400 text-sm leading-relaxed">The mass exodus of highly trained, experienced officers leaves forces under-resourced and communities vulnerable.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <CheckCircle className="w-6 h-6 text-amber-500 shrink-0 mt-0.5" />
                    <div>
                      <strong className="block text-white mb-1 uppercase tracking-wider text-sm">Public Safety Risk</strong>
                      <span className="text-slate-400 text-sm leading-relaxed">When officers cannot perform their duties with confidence, criminals are emboldened and the public is left less safe.</span>
                    </div>
                  </li>
                </ul>
              </div>
