...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#02050A] pt-4 sm:pt-8 md:pt-10 pb-[max(1rem,env(safe-area-inset-bottom))] sm:pb-[max(2.5rem,env(safe-area-inset-bottom))] text-white font-sans overflow-hidden border-t border-white/5">
