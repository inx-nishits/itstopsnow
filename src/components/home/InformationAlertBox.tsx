  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-12 py-2 sm:py-2.5 mx-auto text-center sm:text-left leading-relaxed">
        <span className="inline-block align-middle px-2 py-[2px] mr-2 rounded bg-white text-[#1877F2] text-xs lg:text-sm font-black uppercase tracking-[0.15em] shadow-sm relative -top-[1px]">
          {alert.badgeLabel}
        </span>
        <span className="inline text-xs lg:text-sm font-medium align-middle">
          {alert.messageBefore}
        ...
        {alert.ctaLabel && alert.ctaHref ? (
          <Link
            href={alert.ctaHref}
            className="group inline-flex items-center gap-0.5 text-white hover:text-blue-100 text-xs lg:text-sm font-bold uppercase tracking-[0.1em] transition-colors duration-200 ml-2 whitespace-nowrap align-middle"
          >
